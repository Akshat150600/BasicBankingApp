...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO "+Util.TABLE_NAME_USER+" VALUES(1,'9893828364', 'Aayush', 20000, 'Aayush@gmail.com')");
        db.execSQL("INSERT INTO "+Util.TABLE_NAME_USER+" VALUES(2,'9827327463', 'Jasbir', 30000, 'jasbir@gmail.com')");
        db.execSQL("INSERT INTO "+Util.TABLE_NAME_USER+" VALUES(3,'9723683672', 'Aman', 35000, 'Aman@gmail.com')");
        db.execSQL("INSERT INTO "+Util.TABLE_NAME_USER+" VALUES(4,'9893828364', 'Vivek', 36000, 'Vivek@gmail.com')");
        ...
        db.execSQL("INSERT INTO "+Util.TABLE_NAME_USER+" VALUES(10,'9526367428', 'Simran', 32000, 'Simran@gmail.com')");
